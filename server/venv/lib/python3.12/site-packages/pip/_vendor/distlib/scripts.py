...
<<<<<<< HEAD:server/venv/lib/python3.12/site-packages/pip/_vendor/distlib/scripts.py
            # Issue 31: don't hardcode an absolute package name, but
            # determine it relative to the current package
            distlib_package = __name__.rsplit('.', 1)[0]
...
>>>>>>> f333dca388a4549fd30969a50bcf7d3b44518c6d:server/env/Lib/site-packages/pip/_vendor/distlib/scripts.py
