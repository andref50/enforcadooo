...
import sys
import urllib.parse
<<<<<<< HEAD:server/venv/lib/python3.12/site-packages/pip/_internal/vcs/versioncontrol.py
from typing import (
    TYPE_CHECKING,
=======
from dataclasses import dataclass, field
from typing import (
>>>>>>> f333dca388a4549fd30969a50bcf7d3b44518c6d:server/env/Lib/site-packages/pip/_internal/vcs/versioncontrol.py
    Any,
    Dict,
    Iterable,
    Iterator,
