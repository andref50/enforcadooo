...
from typing import (
    ...
    NewType,
    Optional,
<<<<<<< HEAD:server/venv/lib/python3.12/site-packages/pip/_internal/operations/install/wheel.py
=======
    Protocol,
>>>>>>> f333dca388a4549fd30969a50bcf7d3b44518c6d:server/env/Lib/site-packages/pip/_internal/operations/install/wheel.py
    Sequence,
    Set,
    Tuple,
    Union,
